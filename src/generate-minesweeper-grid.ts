...
export function generateMinesweeperGrid ({rows, cols, mines}: GenerateMinesweeperGridConfig): Cell[][] {
    ...
    const cellGridWithNeighbours = populateGridWithNieghboursAmounts(cellGridWithMines);
  ...
  function populateCellGridWithMines (cellGrid: Cell[][], minesPositions: number[]): Cell[][] {
  ...
  function getNeighbouringMinesAmount (cell: Cell, cellGrid: Cell[][]): number | null {
